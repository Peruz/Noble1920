...
if do_process:
    ...
    if table_to_process.empty:
        ...
        for i, r in table_to_process.iterrows():
            f =r['file']
            if 'DD2' in f: k_file = 'kfiles/sim_dd2.data'
            elif 'GRAD_C_NOWEN' in f: k_file = 'kfiles/sim_grad_nowen.data'
            elif 'GRAD_MMDCCC' in f: k_file = 'kfiles/sim_grad_MMCDDD.data'
...
if do_plot2d:
    print('\nPLOT')
    table_to_plot = select_table(table, which='new', col_check='plot', col_needed='fvtk')
